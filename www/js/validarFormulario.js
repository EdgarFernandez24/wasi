        ...
        if (!(/^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$/i.test($email))) {
            ...
            $("#EmailR").blur(function(){ //verificar por doble ejecucion!!!
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: 'http://192.168.0.160/wasiWeb/php/consultaEmail.php',//'http://192.168.1.145/wasiWeb/php/consultaEmail.php',
       ...
       if($passwordP == null || $passwordP.length < 6 ) {
            ...
            return false;
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: 'http://192.168.0.160/wasiWeb/php/consultaPassword.php',//'http://192.168.1.145/wasiWeb/php/',
