  $(document).ready(function(){
    ...
    document.getElementById('fotoPerfil').addEventListener('change', archivo, true); 
      ...
      $("#clist").click(function(){ //click en el icono basurero para ocultar la imagen mostrada
      $("#list").css({"background": "url(img/usuario.jpg) no-repeat center center","backgroundSize" : "150px 150px"}); 
...
/*
    function archivoA(evt){
      ...
      for (var i = 0, f; f = filesA[i]; i++) {
        //Solo admitimos imágenes.
        if (!f.type.match('image.*')) { //si el archivo selecionado no es imagen.*
          $("#listA").css({"background": "url(img/usuario.jpg) no-repeat center center ","backgroundSize" : "150px 150px"}); //mostramos foto por defecto 
          ...
          reader.onload = (function(theFileA) {
            return function(e) {
              $("#listA").css({"backgroundImage": "url('" + e.target.result + "')","backgroundSize" : "150px 150px"});
    ...
    document.getElementById('fotoPerfilA').addEventListener('change', archivoA, true); 
     ...
     $("#clistA").click(function(event){ //click en el icono basurero para ocultar la imagen mostrada
      ...
      $("#listA").css({"background": "url(img/usuario.jpg) no-repeat center center","backgroundSize" : "150px 150px"}); 
